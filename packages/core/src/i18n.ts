...
const esOverrides: Record<string, string> = {
        ...
        'settings.aiThinkingHint': 'Solo Gemini. 0 desactiva el pensamiento extendido.',
...
const deOverrides: Record<string, string> = {
        ...
        'settings.aiThinkingBudget': 'Thinking‑Budget',
        'settings.aiThinkingHint': 'Nur Gemini. 0 deaktiviert erweitertes Denken.',
...
const jaOverrides: Record<string, string> = {
        ...
        'settings.aiThinkingHint': 'Gemini のみ。0 で拡張思考を無効化。',
